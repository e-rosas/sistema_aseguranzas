            ...
            <div class="modal-body p-0">
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <form role="form" method="post" action="{{ route('beneficiaries.update') }}"  autocomplete="off">
                            @csrf 
                            {{--  person_data --}}
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-auto">
                                    ...
                                    <input type="text" name="city" id="input-city" class="form-control form-control-alternative" placeholder="{{ __('City') }}" value="" required>

                                </div>
                                <div class="form-group col-md-4 col-auto">
                                    <label class="form-control-label" for="input-state">{{ __('State') }}</label>
                                    <input type="text" name="state" id="input-state" class="form-control form-control-alternative" placeholder="{{ __('State') }}" value="" required>
                                </div>
                                <div class="form-group col-md-4 col-auto">
